...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__28985__auto__,writer__28986__auto__,opt__28987__auto__){
return cljs.core._write.call(null,writer__28986__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__29870 = o;
(G__29870[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__29871__delegate = function (args){
...
return G__29871__delegate.call(this,args);};
G__29871.cljs$lang$maxFixedArity = 0;
G__29871.cljs$lang$applyTo = (function (arglist__29873){
var args = cljs.core.seq(arglist__29873);
return G__29871__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__28367__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__28367__auto__){
var and__28367__auto____$1 = jsprops.hasOwnProperty("onChange");
if(cljs.core.truth_(and__28367__auto____$1)){
return jsprops.hasOwnProperty("value");
} else {
return and__28367__auto____$1;
}
} else {
...
var G__29878 = jsprops;
(G__29878["defaultValue"] = value);

(G__29878["onChange"] = ((function (G__29878,v,value,on_change){
return (function (p1__29876_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__29876_SHARP_);
});})(G__29878,v,value,on_change))
);
...
var vec__29885 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__29885,(0),null);
var id = cljs.core.nth.call(null,vec__29885,(1),null);
var class$ = cljs.core.nth.call(null,vec__29885,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___29890 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___29890 == null)){
} else {
var key_29891 = temp__4661__auto___29890;
(jsprops["key"] = key_29891);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__29893 = (new reagent.impl.template.NativeWrapper());
(G__29893["name"] = c);
...
var len__29454__auto___29899 = arguments.length;
var i__29455__auto___29900 = (0);
while(true){
if((i__29455__auto___29900 < len__29454__auto___29899)){
args__29461__auto__.push((arguments[i__29455__auto___29900]));

var G__29901 = (i__29455__auto___29900 + (1));
i__29455__auto___29900 = G__29901;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__29462__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq29897){
var G__29898 = cljs.core.first.call(null,seq29897);
var seq29897__$1 = cljs.core.next.call(null,seq29897);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__29898,seq29897__$1);
});
...
break;
default:
var G__29905 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__29905;
continue;
...
var n__29294__auto___29908 = a.length;
var i_29909 = (0);
while(true){
if((i_29909 < n__29294__auto___29908)){
(a[i_29909] = reagent.impl.template.as_element.call(null,(a[i_29909])));
...
var a = cljs.core.into_array.call(null,s);
var n__29294__auto___29911 = a.length;
var i_29912 = (0);
while(true){
if((i_29912 < n__29294__auto___29911)){
var val_29913 = (a[i_29912]);
if((cljs.core.vector_QMARK_.call(null,val_29913)) && ((reagent.impl.template.key_from_vec.call(null,val_29913) == null))){
(o["no-key"] = true);
} else {
}

(a[i_29912] = reagent.impl.template.as_element.call(null,val_29913));

var G__29914 = (i_29912 + (1));
i_29912 = G__29914;
continue;
} else {
}
...
var ctx = {};
var vec__29918 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__29918,(0),null);
var derefed = cljs.core.nth.call(null,vec__29918,(1),null);
...
var G__29922 = (cljs.core.count.call(null,argv) - first_child);
switch (G__29922) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__29922){
...
//# sourceMappingURL=template.js.map?rel=1489204424949